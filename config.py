...
BOT_IDENTITY = {
    'token'    : '<hipchat token>',
    'username' : '<hipchat jabber username>@chat.hipchat.com',
...
CHATROOM_PRESENCE = (
    '124353_test-1@conf.hipchat.com',
    'OSP',
    'Offtopic',
    # '124353_#osp_platform@conf.hipchat.com',
    'DORA Public',
    'RELEASES',
    'T2',
    'T3',
    'Welcome to the Freakshow',
    '124353_osp_-_córdoba@conf.hipchat.com',
    '124353_integrations@conf.hipchat.com',
    '124353_team_cuatro@conf.hipchat.com',
    'test-1',
)
...
try:
    ...
    raise
    import sys
    sys.exit('Please, define local_settings.py')
